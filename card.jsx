/* Infinito Hiro — digital card.
   Default: Japanese. EN available via discreet toggle.
   Mobile-first single column, museum-quiet. */
...
function Card() {
  ...
  return (
    <div className="ih-page" lang={t.locale}>
      {/* faint paper grain — SVG fractalNoise, very low opacity */}
      <div className="ih-grain" aria-hidden="true" />

      {/* discreet language switch, top-right */}
